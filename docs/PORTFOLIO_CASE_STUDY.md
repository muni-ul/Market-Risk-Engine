...
- Recorded order status counts plus expected and generated artifact names in run metadata so reviewers can audit execution behavior and output completeness.
