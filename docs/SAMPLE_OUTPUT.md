...
- Strategy: `simple_delta_rule`
- Buy when delta is below: configured threshold
- Sell when delta is above: configured threshold
- Trade quantity: configured simulated quantity
- Minimum steps between trades: configured cooldown
