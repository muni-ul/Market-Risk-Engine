...
2. Skim `docs/REQUIREMENTS_TRACEABILITY.md` for the original requirements mapped to current repo evidence.
3. Skim `docs/ARCHITECTURE.md` for the module responsibilities and data flow.
4. Skim `docs/CONFIG_REFERENCE.md` for the YAML inputs that drive the run.
5. Skim `docs/VALIDATION_NOTES.md` for defensive checks and edge-case coverage.
6. Open `docs/SAMPLE_OUTPUT.md` for the expected terminal output and report shape.
7. Open `docs/DEMO_WALKTHROUGH.md` for the screenshot targets and short talk track.
8. Inspect `docs/sample_outputs/artifact_manifest.md`, `docs/sample_outputs/csv_contracts.md`, and `docs/sample_outputs/chart_artifacts.md` for the generated artifact contracts.
9. Read `docs/PORTFOLIO_CASE_STUDY.md` for the engineering decisions and interview story.
10. Use `docs/FINAL_REVIEW_CHECKLIST.md` for the final local validation pass before resume use.
