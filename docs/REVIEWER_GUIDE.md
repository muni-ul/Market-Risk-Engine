...
4. Inspect `docs/sample_outputs/artifact_manifest.md`, `docs/sample_outputs/csv_contracts.md`, and `docs/sample_outputs/chart_artifacts.md` for the generated artifact contracts.
