...
- `run_metadata_example.md`: reproducibility metadata shape, including config digest, order status counts, expected artifacts, generated artifacts, and generated artifact byte sizes.
