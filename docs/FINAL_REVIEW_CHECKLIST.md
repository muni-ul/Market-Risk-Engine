...
- README links to `docs/README.md`, `docs/REVIEWER_GUIDE.md`, `docs/CONFIG_REFERENCE.md`, `docs/SAMPLE_OUTPUT.md`, `docs/sample_outputs/`, `docs/sample_outputs/artifact_manifest.md`, `docs/PORTFOLIO_CASE_STUDY.md`, `CHANGELOG.md`, and this checklist.
