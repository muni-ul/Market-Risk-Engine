...
- Real `src/pyrisklab/` package layout with CLI, config loading, orchestration, pricing, Greeks, strategy, fake execution, portfolio, risk, reporting, and benchmark modules.
